...
export class ApiService {
  ...
  updateFriendById(id: string, updateData: any): Observable<any>{
    return this.http.put<any>(`${this.apiUrl}/friends/${id}`, updateData);
  }

  deleteFriendById(id:string): Observable<any>{
    return this.http.delete<any>(`${this.apiUrl}/friends/${id}`);
  }

  createFriendReq(friendReq: any): Observable<any> {
    return this.http.post<any>(`${this.apiUrl}/friends`, friendReq);
  }
}